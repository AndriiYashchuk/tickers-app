...
export const App = () => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Header, { logo: { title: 'Tickers', to: '/' }, links: isLoading
                ? BASE_HEADER_OPTIONS
        ...
        React.createElement(Main, null,
            React.createElement(Router, { history: history },
                React.createElement(Switch, null,
                    React.createElement(Route, { path: "/aboute", exact: true, component: () => (React.createElement(AboutPage, null)) }),
                    React.createElement(Route, { path: "/", component: () => (isLoading
                            ? React.createElement(DashboardSkeletons, null)
